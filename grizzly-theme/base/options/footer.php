		...
		array(
			...
			'options' 	=> array(
				...
				array(
					...
					'images' 		=> array(
						'1-column' 		=> 'footer-layout/1-column.png',
						'2-columns' 	=> 'footer-layout/2-columns.png',
						'2-columns-2' 	=> 'footer-layout/2-columns-2.png',
						'2-columns-3' 	=> 'footer-layout/2-columns-3.png',
						'3-columns' 	=> 'footer-layout/3-columns.png',
						'3-columns-2' 	=> 'footer-layout/3-columns-2.png',
						'3-columns-3' 	=> 'footer-layout/3-columns-3.png',
						'4-columns' 	=> 'footer-layout/4-columns.png'
					)
				)
