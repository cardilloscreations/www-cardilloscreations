...
function theme_shortcode_twitter_feeds($atts) {
	...
	if( !(theme_options('advance', 'twitter_consumer_key') &&
...
return '<div class="box-wrap notice-box"><div class="box">Please set Twitter App info at <strong>"WP-Admin > Grizzly > Setting > Advance > Twitter App"</strong></div></div>';
	}
